...
| 全局状态 | [global.md](references/global.md) | 使用 `Global` trait、`cx.set_global` 或应用级配置时 |
...
| 测试 | [test.md](references/test.md) | 使用 `#[gpui::test]`、`TestAppContext`、`VisualTestContext` 时 |
