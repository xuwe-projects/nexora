...
description: 使用 Axum 0.8、Tokio 与 Tower 在 Nexora workspace 中实现或审查 HTTP API。适用于 Router/handler、extractor、中间件、认证授权、错误响应、应用状态、优雅关闭和集成测试，并遵循 Router/handlers、Application/Store 与 composition root 的项目分层。
---
