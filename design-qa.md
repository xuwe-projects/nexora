...
- Colors and visual tokens: light mode uses the Nexora light tokens; dark mode uses the Nexora dark tokens and a dedicated `#181a1f` network asset, eliminating the former white rectangle and invisible white-on-white heading.
