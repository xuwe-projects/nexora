...
const SKILL_SOURCES: &[SkillSource] = &[
    ...
    skill_source!("develop-nexora-updater/SKILL.md"),
    skill_source!("develop-nexora-updater/agents/openai.yaml"),
    skill_source!("develop-nexora-updater/references/updater-protocol.md"),
    ...
    skill_source!("manage-sqlx-migrations/SKILL.md"),
    skill_source!("manage-sqlx-migrations/agents/openai.yaml"),
    skill_source!("refine-implementation-spec/SKILL.md"),
    skill_source!("refine-implementation-spec/agents/openai.yaml"),
...
pub(super) const DIRECTORIES: &[&str] = &[
    ...
    ".agents/skills/develop-nexora-updater/agents",
    ".agents/skills/develop-nexora-updater/references",
    ...
    ".agents/skills/manage-sqlx-migrations",
    ".agents/skills/manage-sqlx-migrations/agents",
    ".agents/skills/refine-implementation-spec",
    ".agents/skills/refine-implementation-spec/agents",
